...
import com.zm.hsy.R;
import com.zm.hsy.adapter.ImageGridAdapter;
import com.zm.hsy.adapter.ImageGridAdapter.TextCallback;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		bt.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (Bimp.act_bool) {
					Intent intent = new Intent(ImageGridActivity.this, AddBBSTopicActivity.class);
