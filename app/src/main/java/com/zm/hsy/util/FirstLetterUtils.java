...
public class FirstLetterUtils {
    ...
    private final static String firstLetterArray =
    ...
    public static char getLetter(String name){
        Character letter;
        char unicodeLetter = name.charAt(0);
        int index = unicodeLetter - HANZI_START;
        if (index >= 0 && index <= HANZI_COUNT){
            letter = (char) (firstLetterArray.charAt(index) - 32);
        }else{
            letter = '#';
        }
        return  letter;
