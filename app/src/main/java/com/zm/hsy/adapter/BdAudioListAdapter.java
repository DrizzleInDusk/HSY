...
public class BdAudioListAdapter extends BaseAdapter {
	private Context context;
	private LayoutInflater minflater;
	private ArrayList<Album> albumList = new ArrayList<Album>();;

	public BdAudioListAdapter(Context context, ArrayList<Album> albumList) {
		super();
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (episode != null && episode != "" && episode != "null") {
			holder.list_episode.setText(episode + "集");
		} else {
			holder.list_episode.setText("暂无");
		}
