 ...
 * 购买积分
 */
public class GoumaijifenActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_goumaijifen);
		context = this;
	...
	public void goHTWX() {
		...
		map.put("fee", RMB);
		map.put("describe", "购买积分");
		map.put("attach","jifen-" + userid + ",0,0,weixin");
...
//							}
		...
		public void handleMessage(Message msg) {
			...
			case SDK_PAY_FLAG: {
				...
				if (TextUtils.equals(resultStatus, "9000")) {
					Futil.showMessage(context, "积分购买成功！");
					RMB = "";
				} else {
					...
					if (TextUtils.equals(resultStatus, "8000")) {
						...
						Futil.showMessage(context, "已取消本次购买....");
					}
				}
				break;
			}
	...
	public void alipaypay() {
		...
		String orderInfo = getOrderInfo("购买积分", "jifen-" + userid +  ",0,0" + ",zhifubao", RMB);
		...
		Runnable payRunnable = new Runnable() {
			...
			public void run() {
				// 构造PayTask 对象
				PayTask alipay = new PayTask(GoumaijifenActivity.this);
				// 调用支付接口，获取支付结果
