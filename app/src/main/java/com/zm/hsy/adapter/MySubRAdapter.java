 ...
 * 
 */
public class MySubRAdapter extends BaseAdapter {
	private Context context;
	private LayoutInflater minflater;
	private ArrayList<Album> albumList = new ArrayList<Album>();

	public MySubRAdapter(Context context, ArrayList<Album> albumList) {
		super();
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = minflater.inflate(R.layout.activity_phs_subscribe_item1, null);
