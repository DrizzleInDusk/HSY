 ...
 * 
 */
public class SearchF5Adapter extends BaseAdapter {
	Context context;
	private LayoutInflater minflater;
	private ArrayList<Album> albumList = new ArrayList<Album>();

	public SearchF5Adapter(Context context, ArrayList<Album> albumList) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		ViewHolder holder;
		if (convertView == null) {
			convertView = minflater.inflate(R.layout.activity_search_item5, null);
		...
		holder.rl.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg1) {
				ActivityJumpControl.getInstance((Activity) context)
						.gotoVideoPlayActivity(aublm_id);
			}
		});
	...
	static class ViewHolder {
		TextView aublm_name, aublm_blurb, aublm_playAmount;
