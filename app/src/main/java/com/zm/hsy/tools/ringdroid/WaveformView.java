...
package com.zm.hsy.tools.ringdroid;
 ...
 *
 *
 * waveformview是一个Android视图显示的可视化表示的音频波形。你从cheapsoundfile对象框架和重新获得的轮廓线在几个缩放级别。
 该类不直接处理选择或任何触摸交互，因此它公开了侦听器接口。嵌入该视图的类应该将自己添加为侦听器，并使视图滚动并适当地响应其他事件。
 waveformview实际上并没有处理的选择，但它会以不同的颜色显示的波形的选择。
 */
public class WaveformView extends View {
    ...
    public WaveformView(Context context, AttributeSet attrs) {
        ...
        mGridPaint.setColor(Color.parseColor("#ee01a9a9"));
        mSelectedLinePaint = new Paint();
        mSelectedLinePaint.setAntiAlias(false);
        mSelectedLinePaint.setColor(Color.parseColor("#8dffff"));
        mUnselectedLinePaint = new Paint();
        mUnselectedLinePaint.setAntiAlias(false);
        mUnselectedLinePaint.setColor(Color.parseColor("#106072"));
        mUnselectedBkgndLinePaint = new Paint();
        mUnselectedBkgndLinePaint.setAntiAlias(false);
        mUnselectedBkgndLinePaint.setColor(Color.parseColor("#33000000"));
        mBorderLinePaint = new Paint();
        mBorderLinePaint.setAntiAlias(true);
        mBorderLinePaint.setStrokeWidth(1.5f);
        mBorderLinePaint.setPathEffect(
            new DashPathEffect(new float[] { 3.0f, 2.0f }, 0.0f));
        mBorderLinePaint.setColor(Color.parseColor("#ffffff"));
        mPlaybackLinePaint = new Paint();
        mPlaybackLinePaint.setAntiAlias(false);
        mPlaybackLinePaint.setColor(Color.parseColor("#ffff66"));
        mTimecodePaint = new Paint();
        mTimecodePaint.setTextSize(12);
        mTimecodePaint.setAntiAlias(true);
        mTimecodePaint.setColor(Color.parseColor("#ddffffdd"));
        mTimecodePaint.setShadowLayer(
            2, 1, 1, Color.parseColor("#aa000000"));
