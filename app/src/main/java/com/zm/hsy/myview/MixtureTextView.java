...
public class MixtureTextView extends RelativeLayout
{
    ...
    public MixtureTextView(Context context, AttributeSet attrs)
    {
        ...
        if (mText == null)
        {
            mText = "预览文字！预览文字！预览文字！预览文字！预览文字！预览文字！预览文字！预览文字！预览文字！预览文字！预览文字！预览文字！预览文字！预览文字！预览文字！预览文字！预览文字！预览文字！";
        }
...
//        mTextColor = ta.getColor(TEXT_COLOR, mTextColor);
//        mText = ta.getString(INDEX_ATTR_TEXT);
    ...
    /**
     * 注释：邓志恒
     * StaticLayout(1 字符串资源，2 画笔对象，3 layout宽，4 layout样式，5 相对行间距，6 相对行间距，7 未知);
     * 1234不用动
     * 5，相对字体大小，1.5f表示行间距为1.5倍的字体高度。
     * 6，表示像素
     * 虽然这句可以调整行高，但是不是很理想，这里是把图片的高看做是一行！也就是说，调整高度实际上调整的是
     * 图片和图片下方文字的距离！然后图片两边的文字会显示不全，有点蛋疼！希望找到方法的，或者找到更好demo的
     * 联系 QQ 416643088
     * */
