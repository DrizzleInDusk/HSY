 ...
 * Textview标签自动换行
 */
public class WordWrapViewYuan extends ViewGroup {
     ...
     * @param context
     */
    public WordWrapViewYuan(Context context) {
        super(context);
    }
     ...
     * @param defStyle
     */
    public WordWrapViewYuan(Context context, AttributeSet attrs, int defStyle) {
     ...
     * @param attrs
     */
    public WordWrapViewYuan(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
...
//            view.setBackgroundColor(Color.parseColor("#E9F6FC"));
